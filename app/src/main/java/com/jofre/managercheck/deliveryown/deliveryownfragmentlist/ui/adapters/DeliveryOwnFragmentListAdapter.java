package com.jofre.managercheck.deliveryown.deliveryownfragmentlist.ui.adapters;
 ...
 */
public class DeliveryOwnFragmentListAdapter extends RecyclerView.Adapter<DeliveryOwnFragmentListAdapter.ViewHolder> {
    ...
    private DeliveryOwnFragmentListFragment fragment;

    public DeliveryOwnFragmentListAdapter(List<Check> checkList, ImageLoader imageLoader, OnItemClickListener onItemClickListener, Context context, Fragment fragment) {
        this.checkList = checkList;
        this.imageLoader = imageLoader;
        this.onItemClickListener = onItemClickListener;
        this.context = context;
        this.fragment = (DeliveryOwnFragmentListFragment) fragment;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        DeliveryOwnFragmentListFragment fragment;

        public ViewHolder(View view, DeliveryOwnFragmentListFragment fragment) {
            super(view);
