package com.jofre.managercheck.deliveryown.deliveryownfragmentlist.ui.alerts;
 ...
 */
public class DeliveryOwnFragmentListImageAdapter {
    ...
    public DeliveryOwnFragmentListImageAdapter(Context context, ImageLoader imageLoader, Check check) {
