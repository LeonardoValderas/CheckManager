 ...
 */
public class DeliveryOtherFragmentListAdapter extends RecyclerView.Adapter<DeliveryOtherFragmentListAdapter.ViewHolder> {
    ...
    private DeliveryOtherFragmentListFragment fragment;

    public DeliveryOtherFragmentListAdapter(List<Check> checkList, ImageLoader imageLoader, OnItemClickListener onItemClickListener, Context context, Fragment fragment) {
        this.checkList = checkList;
        this.imageLoader = imageLoader;
        this.onItemClickListener = onItemClickListener;
        this.context = context;
        this.fragment = (DeliveryOtherFragmentListFragment) fragment;
    }
