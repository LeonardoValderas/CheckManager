package com.jofre.managercheck.deliveryother.deliveryotherfragmentlist.ui.alerts;
 ...
 */
public class DeliveryOtherFragmentListImageAdapter {
    ...
    public DeliveryOtherFragmentListImageAdapter(Context context, ImageLoader imageLoader, Check check) {
