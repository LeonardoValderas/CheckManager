...
public class ReceiverAddPresenterImplTest extends BaseTest {
    ...
    @Mock
    private ReceiverAddInteractor receiverAddInteractor;
    @Mock
    private ReceiverAddEvent event;
    @Mock
    Check check;
    @Mock
    private Context context;

    private ReceiverAddPresenterImpl presenter;

    @Override
    public void setUp() throws Exception {
        super.setUp();
        presenter = new ReceiverAddPresenterImpl(eventBus, view, receiverAddInteractor);
    }
