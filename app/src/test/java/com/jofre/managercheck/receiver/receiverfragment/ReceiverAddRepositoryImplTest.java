...
public class ReceiverAddRepositoryImplTest extends BaseTest {
    ...
    private ReceiverFragmentRepositoryImpl repository;
    private ArgumentCaptor<ReceiverFragmentEvent> receiverAddEventArgumentCaptor;

    @Override
    public void setUp() throws Exception {
        super.setUp();
        repository = new ReceiverFragmentRepositoryImpl(eventBus);
        receiverAddEventArgumentCaptor = ArgumentCaptor.forClass(ReceiverFragmentEvent.class);
    }
    ...
    public void testCheckNull_postNull() {
        ...
        ReceiverFragmentEvent event = receiverAddEventArgumentCaptor.getValue();
    ...
    public void testCheckSaveTrue_InsertCheck() {
        ...
        verify(eventBus).post(receiverAddEventArgumentCaptor.capture());
        ReceiverFragmentEvent event = receiverAddEventArgumentCaptor.getValue();
        assertEquals(ReceiverFragmentEvent.COMPLETE_EVENT, event.getType());
    }
    @Test
